...
MONGO_DB_URI = getenv("mongodb+srv://rohillayash281:rohillayash281@cluster0.35b8c.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", True)
...
OWNER_ID = int(getenv("6586095302", True))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ITZMADARA01/SLAYER.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/testing_sikky")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AS_ANIME_GRUOP")
...
#Dont edit this line !!
MITWA = [ "<b>нєу</b> {0}, 💗\n\n๏ ᴛʜɪs ɪs {1} !\n\n➻ {1} ʏᴏᴜʀ ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴜsɪᴄ ʙᴏᴛ! EɴJᴏʏ sᴇᴀᴍʟᴇss 💓 ᴀᴄᴄᴇss ᴛᴏ ᴀɴʏ sᴏɴɢ ᴡɪᴛʜ ʟᴀɢ-ғʀᴇᴇ ᴘᴇʀғᴏʀᴍᴀɴᴄᴇ ᴀɴᴅ ᴛʜᴇ ʙᴇsᴛ ᴀᴜᴅɪᴏ ǫᴜᴀʟɪᴛʏ. Slayer ᴄᴜʀᴀᴛᴇs ᴘᴇʀsᴏɴᴀʟɪᴢᴇᴅ ᴘʟᴀʏʟɪsᴛs, ᴅɪsᴄᴏᴠᴇʀs ɴᴇᴡ ᴀʀᴛɪsᴛs, ᴀɴᴅ ᴇɴʜᴀɴᴄᴇs ʏᴏᴜʀ ʟɪsᴛᴇɴɪɴɢ ᴇxᴘᴇʀɪᴇɴᴄᴇ, ᴍᴀᴋɪɴɢ ɪᴛ ᴛʜᴇ ᴘᴇʀғᴇᴄᴛ ᴄᴏᴍᴘᴀɴɪᴏɴ ғᴏʀ ᴀʟʟ ʏᴏᴜʀ ᴍᴜsɪᴄᴀʟ ᴍᴏᴍᴇɴᴛs 🦋. ᴛᴜɴᴇ ɪɴ ɴᴏᴡ!.\n\n<b><u>Sᴜᴘᴘᴏʀᴛᴇᴅ Pʟᴀᴛғᴏʀᴍs :</b></u> ʏᴏᴜᴛᴜʙᴇ, sᴘᴏᴛɪғʏ, ʀᴇssᴏ, ᴀᴘᴘʟᴇ ᴍᴜsɪᴄ ᴀɴᴅ sᴏᴜɴᴅᴄʟᴏᴜᴅ.\n──────────────────\n<b>๏ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʜᴇʟᴩ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴍʏ ᴍᴏᴅᴜʟᴇs ᴀɴᴅ ᴄᴏᴍᴍᴀɴᴅs🦋.</b> "  ,
        ]
